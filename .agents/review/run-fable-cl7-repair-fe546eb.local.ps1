...
$baseSha = 'bfc84cc4a664a0c28f92949ae9844e0799319407'
$reviewedSha = 'fe546eb61a3259f59673343d72b0a95a8d555038'
...
if ([string]::IsNullOrWhiteSpace($prompt) -or
    ...
    throw 'The repair-delta prompt is empty or missing a pinned SHA.'
}
