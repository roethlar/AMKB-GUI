...
$baseSha = 'ff7576a3912940829bf282c7e15d654017307358'
$reviewedSha = '1a8632b6b1b2dc4926f848235d10dadd4066e6e5'
$model = 'claude-opus-5'
$effort = 'high'
...
if ([string]::IsNullOrWhiteSpace($prompt) -or
    ...
    throw 'The finding-review prompt is empty or missing a pinned SHA.'
}
...
@(
    ...
    '--allowedTools', 'Read', 'Grep', 'Glob', 'Bash(git *)', 'Bash(node *)', 'Bash(uv *)',
