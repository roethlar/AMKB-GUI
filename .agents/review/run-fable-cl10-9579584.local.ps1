...
$baseSha = '1ee73a81182c8f401b1942776d3df7c005541f33'
$reviewedSha = '95795845b6eeabd1c572b82244fef26a975183dd'
$model = 'claude-opus-5'
$effort = 'xhigh'
...
@(
    ...
    '--allowedTools', 'Read', 'Grep', 'Glob', 'Bash(git *)', 'Bash(node *)',
