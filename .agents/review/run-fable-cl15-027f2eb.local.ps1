...
$baseSha = '904f45c4b27ad4b3fdb9e55d31efc3c9610a17e9'
$reviewedSha = '027f2eb18cedd88974ae5a965de2176c0690f801'
$model = 'claude-opus-5'
$effort = 'high'
...
@(
    ...
    '--allowedTools', 'Read', 'Grep', 'Glob', 'Bash(git *)', 'Bash(uv *)',
