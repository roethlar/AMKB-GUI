...
| cl-23 | MEDIUM  | App-native round-trip audit can pass before reopen does anything              | `[x]`  | —      | claude/claude-opus-5/high/standard |
| cl-24 | LOW     | Closing import review retains the review destination instead of editor context | `[x]` | —      | claude/claude-opus-5/high/standard |
...
All ten findings are repaired and red-proven on the current branch:
...
| n567-5 | `21c8e56` |
| n567-6 | `77ff823` |
| n567-9 | `8546d54` (partial), plus the `n567-9:` completion commit |
