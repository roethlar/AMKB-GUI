...
| Step | Outcome | Notes |
|---|---|---|
| 1. Identity | Pass | Physical board: model `NEON80`, definition `AM Neon 80`, firmware UID **[redacted]**, Vial protocol 5, writable `True`, 87 projected layout keys. Read-only; nothing was written. |
