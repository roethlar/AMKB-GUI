...
AM Configurator 0.1.66 is a normal public release of the independent,
...
[AM Configurator 0.1.66 GitHub Release](https://github.com/roethlar/AMKB-GUI/releases/tag/v0.1.66).
...
the [installation guide](https://github.com/roethlar/AMKB-GUI/blob/v0.1.66/docs/installing.md);
...
macros are read back where the protocol supports it. Neon firmware does not expose LED read-back, so reading a Neon is not a backup of its current lighting;
...
- The exact Windows package was installed, audited, smoke-tested, and
  uninstalled successfully. Trust-warning behaviour and a separate Windows
  About launch remain established baseline evidence and were not reenacted.
